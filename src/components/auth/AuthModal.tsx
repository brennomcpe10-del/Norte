  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isForgotPass) {
        ...
        setSuccessInfo('E-mail de recuperação enviado com sucesso!');
      } else if (isSignUp) {
      ...
      <div id="auth-card" className="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden">
        ...
        <div className="p-8 pb-6 text-center bg-radial from-slate-50 to-slate-100/70 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-500 mt-1 max-w-xs mx-auto">
            Seu sistema pessoal de direção semanal. Metas realistas, sem cobrança rígida.
          </p>
        </div>
        ...
        <div className="p-8 pt-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3.5 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-hidden focus:ring-2 focus:ring-slate-900/10 focus:border-slate-800"
                  />
                </div>
              </div>
            )}
            ...
            <button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 py-3 text-sm font-semibold text-white bg-slate-900 hover:bg-slate-800 active:bg-slate-950 disabled:opacity-50 rounded-2xl transition-all shadow-md mt-2 cursor-pointer"
            >
              <span>
                {isLoading
                  ? 'Processando...'
